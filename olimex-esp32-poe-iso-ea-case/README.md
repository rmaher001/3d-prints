...
| `olimex-esp32-poe-iso-ea-case-v2.stl` | Friction-fit lid rework, generated by `modify_case.py` |
| `olimex-esp32-poe-iso-ea-case.3mf` | Bambu Studio plate (P2S) with the original case and the v2 part, saved 2026-06-07 |
