...
def main():
    ...
    STAND_HEIGHT = 2.0     # max 2mm tall, plain cylinder
    ...
    # Union new standoffs into the LOW-X component. Source standoffs stay as they are.
    ...
    output_path = os.path.join(script_dir, "esp32-c6-c4001-enclosure.v2.stl")
