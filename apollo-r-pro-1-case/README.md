...
Printed at 100%, the case grips the PCB hard enough that the board is difficult to remove. Scale the case **and** the lid (`r_pro-1_lid.stl` from the Printables model) to **101% in X only; Y and Z stay 100%**. The board rests by its Y ends on ledges on the two long walls, with well under 0.3 mm of overlap per side. Scaling Y by 101% moves those ledges out about 0.27 mm per side, and the board falls through (tested 2026-09-16). X-only scaling widens the side walls by about 0.24 mm per side and leaves the ledges and the board-lid clamp heights exactly where they were. The lid STL will not print as downloaded. It stands on two small board-hold tabs (about 20 mm² of bed contact), and its outer face is covered in 0.5 mm dimples, so flipped over only about 880 mm² of webbing touches the plate. Both ways end in spaghetti, and the dimples also make it a 1.1M-triangle mesh. Fill the dimples solid (a 0.7 mm slab under the 1 mm plate, taken from the plate's own outline) and print it outer face down. That gives 2,230 mm² of contact and about 1,200 triangles; everything above the plate is unchanged.
